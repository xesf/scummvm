...
const char *VirtualCinemaMetaEngine::getName() const {
	return "virtualcinema";
}

const ADExtraGuiOptionsMap *VirtualCinemaMetaEngine::getAdvancedExtraGuiOptions() const {
	return VirtualCinema::optionsList;
}

Common::Error VirtualCinemaMetaEngine::createInstance(OSystem *syst, Engine **engine, const ADGameDescription *desc) const {
...
bool VirtualCinemaMetaEngine::hasFeature(MetaEngineFeature f) const {
